...
export type BorderBox11Props = BoxProps & { title?: string; titleWidth?: number }

export function BorderBox11({
  children,
  className,
  style,
  color = [],
  ...
  const classNames = useMemo(() => classnames('dv-border-box-11', className), [className])
