...
export type BorderBox8Props = BoxProps & { dur?: number; reverse?: boolean }

export function BorderBox8({
  children,
  className,
  style,
  color = [],
  ...
  const classNames = useMemo(() => classnames('dv-border-box-8', className), [className])
